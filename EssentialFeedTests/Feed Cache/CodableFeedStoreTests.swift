...
final class CodableFeedStoreTests: XCTestCase {
    ...
    func test_retrieve_overridePreviouslyInsertedCachedValue() {
        ...
        expect(sut, toRetrieve: .found(feed: latestFeed, timestamp: latestDate))
    }
    
    func test_retrieve_deliverErrorOnInsertionFailure() {
    ...
    func test_storeSideEffects_runSerially() {
        ...
        XCTAssertEqual(completedOperationInOrder, [opt1, opt2, opt3],"Expected side-effects to run serially but operations finished in the wrong order")
    }
